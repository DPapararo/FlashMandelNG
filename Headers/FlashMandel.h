/*
 *  FlashMandel.h $Ver 3.7 Dino Papararo 14 Nov 2021
 */
...
void JCPoint (struct MandelChunk *, struct RastPort *, uint32 *,
             const int16, const int16);

void MHLine (struct MandelChunk *, struct RastPort *, uint8 *,
            uint32 *, const int16, const int16, const int16);
void MVLine (struct MandelChunk *, struct RastPort *, uint8 *,
            uint32 *, const int16, const int16, const int16);
void JHLine (struct MandelChunk *, struct RastPort *, uint8 *,
            uint32 *, const int16, const int16, const int16);
void JVLine (struct MandelChunk *, struct RastPort *, uint8 *,
            uint32 *, const int16, const int16, const int16);

void MCPoint24bit (struct MandelChunk *, struct RastPort *, uint32 *,
         const int16, const int16);
void JCPoint24bit (struct MandelChunk *, struct RastPort *, uint32 *,
             const int16, const int16);

void MHLine24bit (struct MandelChunk *, struct RastPort *, uint8 *,
            uint32 *, const int16, const int16, const int16);
void MVLine24bit (struct MandelChunk *, struct RastPort *, uint8 *,
            uint32 *, const int16, const int16, const int16);
void JHLine24bit (struct MandelChunk *, struct RastPort *, uint8 *,
            uint32 *, const int16, const int16, const int16);
void JVLine24bit (struct MandelChunk *, struct RastPort *, uint8 *,
            uint32 *, const int16, const int16, const int16);
