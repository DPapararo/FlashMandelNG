...
MOD_O_SPE = $(O)/CalcJuliaOrbit_spe.o $(O)/CalcMandelOrbit_spe.o $(O)/ColorWindow_spe.o $(O)/Gfx_spe.o $(O)/Julian_spe.o $(O)/Mandeln_spe.o $(O)/TurboRender_spe.o $(O)/GfxRender_spe.o
...
$(O)/Gfx_spe.o : $(MOD)/Gfx.c $(H)/FlashMandel.h
	$(CCSPE) $(CFLAGSSPE) -c $(MOD)/Gfx.c -o $(O)/Gfx_spe.o	
