...
#  v0:vMaxDist v1:vCre v14:vCim
#  v15:vZr v16:vZi v17:vZr2/vTmp1 v18:vZi2/vTmp2
#  v19:vDist v8:vPzr v9:vPzi v10:vEpsilon v11:vZero v12:vOne
####################################################################################
...
#    vspltw  %v0,%v0,0           #popolate all vector chunks
    ...
    lvewx   %v14,%r1,%r9         #vCim = Tmp2
#    vspltw  %v1,%v1,0           #popolate all vector chunks
#    vspltw  %v14,%v14,0           #popolate all vector chunks
    lvewx   %v15,%r1,%r8         #vZr = Tmp1
    lvewx   %v16,%r1,%r9         #vZi = Tmp2
#    vspltw  %v15,%v15,0           #popolate all vector chunks
#    vspltw  %v16,%v16,0           #popolate all vector chunks
...
.PowerLoop1:
    vmaddfp %v18,%v16,%v16,%v11    #vZi2 = vZi * vZi + vZero
    vmaddfp %v16,%v16,%v15,%v11    #vZi *= vZr + vZero
    vmaddfp %v17,%v15,%v15,%v11    #vZr2 = vZr * vZr + vZero
    vaddfp	%v16,%v16,%v16         #vZi += vZi
    vsubfp  %v15,%v17,%v18         #vZr = vZr2 - vZi2
    bdnz 	.PowerLoop1         #if Power > 0 goto .PowerLoop1

	vaddfp 	%v19,%v17,%v18         #Dist = vZr2 + vZi2
	vcmpgtfp. %v19,%v19,%v0       #compare dist with Radius
    bne-    %cr6,.Exit          #if dist > radius goto .Exit
#    cmpwi   %cr5,%r3,0          #compare Iterations with 0
#    beq-    %cr5,.Exit          #if Iterations == 0 goto .Exit
    vaddfp 	%v16,%v16,%v14         #vZi += vCim
    vaddfp  %v15,%v15,%v1         #vZr += vCre

#	check periodicity method (1) reusing Zr2 and Zi2 as Temp vars
#    vsubfp  %v17,%v15,%v8          #Tmp1 = Zr - Pzr
#    vspltisw %v17,-1              #
#    vslw %v18,%v17,%v17             #
#    vandc %v17,%v17,%v18            # Tmp1 = |Tmp1|
#    vcmpgtfp %v17,%v17,%v10       #compare Tmp1 with Epsilon
#    vand 	 %v17,%v17,%v12
#    beq    %cr6,.NoPeriodicity   #if Pzr >= Epsilon goto .NoPeriodicity
#    vsubfp  %v18,%v16,%v9          #Tmp2 = Zi - Pzi
#    vspltisw %v18,-1              #
#    vslw %v17,%v18,%v18             #
#    vandc %v18,%v18,%v17            # Tmp2 = |Tmp2|
#    vcmpgtfp %v18,%v18,%v10       #compare Tmp2 with Epsilon
#    vand 	 %v18,%v18,%v12
...
#    vaddfp  %v8,%v11,%v15        #Pzr = zr
#    add     %r6,%r6,%r6         #PTot += PTot
#    vaddfp  %v9,%v11,%v16        #Pzi = zi
